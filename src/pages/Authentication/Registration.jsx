...
const Registration = () => {
    ...
    return (
        <div className='my-5 flex justify-center items-center'>
            <div className='flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg  lg:max-w-4xl px-3'>
                    ...
                    <form onSubmit={handleRegister}>
                        <div className='mt-4'>
                            ...
                            <input
                                ...
                                autoComplete='email'
                                name='email'
                                className='block w-full px-4 py-2 text-gray-700 bg-white border rounded-lg    focus:border-secondary focus:ring-opacity-40  focus:outline-none focus:ring focus:ring-blue-300'
                                type='email'
                                required
                            />
                        </div>
